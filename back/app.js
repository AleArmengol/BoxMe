...
app.post('/api/insertarCaja', function(req, res) {
	...
	//console.log(nombre);
	request = new Request('INSERT Cajas (nombre) VALUES (@nombre)', function(error) {
		if (error) {
			console.log(error);
		}
	});
...
app.post('/api/insertarItem', function(req, res) {
	...
	console.log(nombre);
	console.log(cant);
	var request = new Request('INSERT INTO Items (idCaja,nombre, cant) VALUES (@idCaja, @nombre, @cant)', function(
		error
	) {
		if (error) {
			console.log(error);
...
app.delete('/api/deleteItem', function(req, res) {
	var nombre = req.body.nombre;
	console.log(nombre);
	request = new Request('DELETE FROM Items WHERE nombre = @nombre', function(error) {
		if (error) {
			console.log(error);
		}
	});
...
app.delete('/api/deleteItemById', function(req, res) {
	var idCaja = req.body.idCaja;
	console.log(idCaja);
	var request = new Request('DELETE FROM Items WHERE idCaja = @idCaja', function(error) {
		if (error) {
			console.log(error);
		}
	});
...
app.put('/api/updateNombreItem', function(req, res) {
	...
	console.log(nombre);
	console.log(idItem);
	request = new Request('UPDATE Items SET nombre = @nombre WHERE idItem= @idItem', function(error) {
		if (error) {
			console.log(error);
		}
	});
...
app.put('/api/updateCantidadItem', function(req, res) {
	...
	request = new Request('UPDATE Items SET cantidad = @cantidad WHERE idItem= @idItem', function(error) {
		if (error) {
			console.log(error);
		}
	});
...
app.put('/api/updateNombreCaja', function(req, res) {
	...
	console.log(nombre);
	console.log(idCaja);
	request = new Request('UPDATE Cajas SET nombre = @nombre WHERE idCaja= @idCaja', function(error) {
		if (error) {
			console.log(error);
		}
	});
...
app.put('/api/updateNombreMudanzas', function(req, res) {
	...
	request = new Request('UPDATE Mudanzas SET nombre = @nombre WHERE idMudanza= @idMudanza', function(error) {
		if (error) {
			console.log(error);
		}
	});
